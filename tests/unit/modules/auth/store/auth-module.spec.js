...
describe('Vuex: Purebas en el auth-Module', () => {
    ...
    test('Actions: createUser signInUser - Crea el usuario', async() => {
        ...
        const deleteResp = await axios.post(`https://identitytoolkit.googleapis.com/v1/accounts:delete?key=AIzaSyA83bgIiNnirVAb6hkxNwSfK0VnvCZUtTM`, {
            idToken
        })
